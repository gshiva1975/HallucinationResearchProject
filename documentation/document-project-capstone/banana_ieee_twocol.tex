...
%  IEEE Two-Column Format  |  AAI590 Capstone  |  April 2026
%  University of San Diego
%  Converted to IEEEtran document class
% =================================================================
...
% ── Title ─────────────────────────────────────────────────────────
\title{Reducing Hallucination in Financial AI Through\\
  Retrieval-Augmented Agentic Design}

\author{%
  \IEEEauthorblockN{Gangadhar Singh Shiva,~Akshobhya Rao BV,~and Ananya Chandraker}
  \IEEEauthorblockA{%
    Master of Science in Applied Artificial Intelligence\\
    Shiley Marcos School of Engineering, University of San Diego\\
    \texttt{\{gshiva, abv, achandraker\}@sandiego.edu}
  }
  \thanks{Technical Report No.\ MSAAI-2026-05, April 2026, Version 2.0.
    AAI590 Capstone Project, University of San Diego.}
}

\markboth{IEEE-Style Technical Report --- AAI590 Capstone, University of San Diego, April 2026}%
{Shiva \MakeLowercase{\textit{et al.}}: Reducing Hallucination in Financial AI}
...
\IEEEPARstart{F}{inancial} markets generate large volumes of heterogeneous data,
